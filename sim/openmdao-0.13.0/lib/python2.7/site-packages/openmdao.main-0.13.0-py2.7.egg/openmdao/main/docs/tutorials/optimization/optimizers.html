...
<p>We&#8217;ve gone ahead and imported every optimizer to make swapping them fairly
...
supported (e.g., equality constraints are only supported by SLSQPdriver.)</p>
<p>Some optimizers, like CONMINdriver, have their own finite difference
capability for calculating the gradient. Others, like <tt class="docutils literal"><span class="pre">SLSQ_driver</span></tt>, do not
...
<tt class="docutils literal"><span class="pre">conmin_diff</span></tt> flag to True, and it will perform a backward difference with
...
provided to speed up the calculation.</p>
...
<div class="highlight-python"><div class="highlight"><pre>Optimizer: &lt;class &#39;openmdao.lib.drivers.conmindriver.CONMINdriver&#39;&gt;
...
<p>Next we&#8217;ll let OpenMDAO perform the finite difference instead of CONMIN. To
do this, set this <tt class="docutils literal"><span class="pre">conmin_diff</span></tt> flag to False, which is its default value.</p>
<div class="highlight-python"><div class="highlight"><pre><span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">conmin_diff</span> <span class="o">=</span> <span class="bp">False</span>
</pre></div>
</div>
<p>Then run <tt class="docutils literal"><span class="pre">demo_opt.py</span></tt>.</p>
<div class="highlight-python"><div class="highlight"><pre>Function executions:  18
...
OpenMDAO, we just kept the default value.</p>
...
<span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">conmin_diff</span> <span class="o">=</span> <span class="bp">False</span>
...
<p>Then run <tt class="docutils literal"><span class="pre">demo_opt.py</span></tt>.</p>
<div class="highlight-python"><div class="highlight"><pre>Optimizer: &lt;class &#39;openmdao.lib.drivers.newsumtdriver.NEWSUMTdriver&#39;&gt;
...
<p>NEWSUMT need the Hessian or second-derivatives of the objective and
...
<div class="highlight-python"><div class="highlight"><pre>Optimizer: &lt;class &#39;openmdao.lib.drivers.cobyladriver.COBYLAdriver&#39;&gt;
...
<div class="highlight-python"><div class="highlight"><pre>Optimizer: &lt;class &#39;openmdao.lib.drivers.slsqpdriver.SLSQPdriver&#39;&gt;
...
<div class="highlight-python"><div class="highlight"><pre>Optimizer: &lt;class &#39;openmdao.lib.drivers.genetic.Genetic&#39;&gt;
