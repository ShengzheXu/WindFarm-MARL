...
<div class="highlight-python"><div class="highlight"><pre>python optimization_unconstrained.py
</pre></div>
</div>
<p>This should produce the output:</p>
<div class="highlight-python"><div class="highlight"><pre>Minimum found at (6.666309, -7.333026)
...
<div class="highlight-python"><div class="highlight"><pre>timestamp loglevel source: message
</pre></div>
</div>
...
include this in your top level script:</p>
...
<div class="highlight-python"><div class="highlight"><pre>timestamp loglevel [server] source: message
</pre></div>
</div>
