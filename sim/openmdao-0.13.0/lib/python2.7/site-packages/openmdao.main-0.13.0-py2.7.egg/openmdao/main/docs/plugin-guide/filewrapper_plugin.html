...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link rel="next" title="Installing an OpenMDAO Plugin" href="plugin_install.html" />
      ...
      <ul>
        ...
        <li class="right" >
          <a href="../py-modindex.html" title="Python Module Index"
             >modules</a> |</li>
        <li class="right" >
          <a href="plugin_install.html" title="Installing an OpenMDAO Plugin"
...
<div class="highlight-python"><div class="highlight"><pre>/usr/bin/externalcode -v -r1
</pre></div>
</div>
...
<div class="highlight-python"><div class="highlight"><pre>/usr/bin/externalcode -v -r1 &lt; myinput.txt &gt; myoutput.txt
</pre></div>
</div>
...
<div class="highlight-python"><div class="highlight"><pre>NAMEIn
! Comment string
&amp;GROUP1
 XREAL =  1.0e33,
 XINT = 2,
...
text-file output:</p>
<div class="highlight-python"><div class="highlight"><pre>LOAD CASE 1
...
<div class="highlight-python"><div class="highlight"><pre>FREQ  DELTA   A     B     C     D     E     F     G     H     I     J
 Hz
...
<div class="highlight-python"><div class="highlight"><pre>CASE 1
3,7,2,4,5,6
</pre></div>
</div>
...
<div class="highlight-python"><div class="highlight"><pre>CASE 2
...
<li><a class="reference internal" href="#special-case-delimiter-columns"><em>Special Case Delimiter - Columns</em></a></li>
  ...
  <h4>Next topic</h4>
  <p class="topless"><a href="plugin_install.html"
                        title="next chapter">Installing an OpenMDAO Plugin</a></p>
  <h3>This Page</h3>
