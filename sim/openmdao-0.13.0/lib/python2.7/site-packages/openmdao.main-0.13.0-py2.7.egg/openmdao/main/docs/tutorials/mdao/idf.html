...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Individual Design Feasible (IDF) &mdash; OpenMDAO Documentation</title>
    ...
    <link rel="next" title="Collaborative Optimization (CO)" href="co.html" />
    <link rel="prev" title="Multidisciplinary Design Feasible (MDF)" href="mdf.html" /> 
  </head>
  <body>
    <div class="related">
      <h3>Navigation</h3>
  ...
  <div class="section" id="individual-design-feasible-idf">
<span id="index-0"></span><span id="id1"></span><h1>Individual Design Feasible (IDF)<a class="headerlink" href="#individual-design-feasible-idf" title="Permalink to this headline">¶</a></h1>
<p>Next, we will look at how to set up the Individual Design Feasible (IDF) architecture for the Sellar
...
solver. The data flow for IDF is illustrated in the following diagram:</p>
<div class="figure align-center">
<img alt="diagram of boxes and arrows showing the data flow for the Individual Design Feasible" src="../../_images/Arch-IDF.png" />
<p class="caption">Data Flow for IDF</p>
</div>
<p>IDF needs only one driver, so there is just one workflow where the two disciplines are executed sequentially.
From the perspective of the iteration hierarchy, IDF is extremely simple.</p>
<div class="figure align-center">
<img alt="The Broadcaster and two disciplines are represented by rounded boxes inside a square box, which is the workflow." src="../../_images/Arch-IDF-OpenMDAO.png" />
<p class="caption">Iteration Hierarchy for IDF</p>
</div>
<p>To implement IDF, we create the <tt class="docutils literal"><span class="pre">SellarIDF</span></tt> assembly. First, all of our components
are instantiated and the workflow is defined.</p>
...
<span class="k">class</span> <span class="nc">SellarIDF</span><span class="p">(</span><span class="n">Assembly</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot; Optimization of the Sellar problem using IDF&quot;&quot;&quot;</span>
...
<span class="sd">        Optimal Objective = 3.18339&quot;&quot;&quot;</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">workflow</span><span class="o">.</span><span class="n">add</span><span class="p">([</span><span class="s">&#39;dis1&#39;</span><span class="p">,</span> <span class="s">&#39;dis2&#39;</span><span class="p">])</span>
</pre></div>
</div>
<p>That&#8217;s all it takes to set up the workflow for IDF. All that is left to do is set up the
optimizer.  In the code below, pay attention to how we handle the global design variables <tt class="docutils literal"><span class="pre">z1</span></tt> and
<tt class="docutils literal"><span class="pre">z2</span></tt>. We set them up the same way we did for the MDF architecture. However, unlike the MDF, the
coupling variables are also included as optimizer  parameters.</p>
...
<span class="c">#Global Design Variables</span>
...
<span class="c">#Local Design Variables and Coupling Variables</span>
...
<span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">add_parameter</span><span class="p">(</span><span class="s">&#39;dis2.y1&#39;</span><span class="p">,</span>      <span class="n">low</span> <span class="o">=</span> <span class="o">-</span><span class="mf">1e99</span><span class="p">,</span> <span class="n">high</span><span class="o">=</span><span class="mf">1e99</span><span class="p">)</span>
<span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">add_parameter</span><span class="p">(</span><span class="s">&#39;dis1.y2&#39;</span><span class="p">,</span>      <span class="n">low</span> <span class="o">=</span> <span class="o">-</span><span class="mf">1e99</span><span class="p">,</span> <span class="n">high</span><span class="o">=</span><span class="mf">1e99</span><span class="p">)</span>
...
<span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">add_constraint</span><span class="p">(</span><span class="s">&#39;(dis2.y1-dis1.y1)**2 &lt;= 0&#39;</span><span class="p">)</span>
<span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">add_constraint</span><span class="p">(</span><span class="s">&#39;(dis2.y2-dis1.y2)**2 &lt;= 0&#39;</span><span class="p">)</span>
...
<p>Technically, IDF requires the use of equality constraints to enforce coupling between the
...
to constrain <tt class="docutils literal"><span class="pre">x=2</span></tt>, we could constraint <tt class="docutils literal"><span class="pre">x&lt;=2</span></tt> and <tt class="docutils literal"><span class="pre">x&gt;=2</span></tt> and let the optimizer converge to a
solution where both constraints are active. Or we could condense  that to a single constraint of
<tt class="docutils literal"><span class="pre">(x-2)**2&lt;=0</span></tt>.  SLSQP is a sequential quadratic programming algorithm that actually does support
equality constraints,  but we&#8217;ve left the inequality forms in there to make it easier to try other
optimziers if you want to.</p>
<p>By the way, you might consider trying a fancier solution such as constraining <tt class="docutils literal"><span class="pre">abs(dis2.y1-dis1.y1)&lt;=0</span></tt>.
...
sample code, instead.</p>
<p>When we put it all together, we get <a class="reference download internal" href="../../_downloads/sellar_IDF.py"><tt class="xref download docutils literal"><span class="pre">sellar_IDF.py</span></tt></a>.  Once again, we added a
small amount of code at the end to execute and then print the results of the IDF optimization.</p>
...
<span class="k">if</span> <span class="n">__name__</span> <span class="o">==</span> <span class="s">&quot;__main__&quot;</span><span class="p">:</span>
    ...
    <span class="n">prob</span> <span class="o">=</span> <span class="n">SellarIDF</span><span class="p">()</span>
    ...
    <span class="n">prob</span><span class="o">.</span><span class="n">dis2</span><span class="o">.</span><span class="n">y1</span> <span class="o">=</span> <span class="mf">3.16</span>
    ...
    <span class="k">print</span> <span class="s">&quot;Minimum found at (</span><span class="si">%f</span><span class="s">, </span><span class="si">%f</span><span class="s">, </span><span class="si">%f</span><span class="s">)&quot;</span> <span class="o">%</span> <span class="p">(</span><span class="n">prob</span><span class="o">.</span><span class="n">dis1</span><span class="o">.</span><span class="n">z1</span><span class="p">,</span> \
                                             <span class="n">prob</span><span class="o">.</span><span class="n">dis2</span><span class="o">.</span><span class="n">z2</span><span class="p">,</span> \
...
<p>Executing this at the command line should produce
output that resembles this:</p>
<div class="highlight-python"><div class="highlight"><pre>$ python sellar_IDF.py
...
border="0" alt="OpenMDAO Home"/>
  ...
  <p class="topless"><a href="mdf.html"
                        title="previous chapter">Multidisciplinary Design Feasible (MDF)</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="co.html"
                        title="next chapter">Collaborative Optimization (CO)</a></p>
  <h3>This Page</h3>
  <ul class="this-page-menu">
    <li><a href="../../_sources/tutorials/mdao/idf.txt"
