...
fundamentals of the OpenMDAO component API and also with creating Python components.</p>
...
system.</p>
<div class="highlight-python"><div class="highlight"><pre>Wrapper Utility: F2PY
...
<div class="highlight-python"><div class="highlight"><pre>openmdao-X.X.X/lib/python2.7/site-packages/openmdao.examples.bar3simulation-X.X.X-######.egg/openmdao/examples/bar3simulation
</pre></div>
</div>
...
<img alt="Lines and arrows showing the geometry of the 3-bar truss" src="../_images/ThreeBar.jpg" />
...
first mode.</p>
<p>The <a class="reference external" href="https://sysbio.ioc.ee/projects/f2py2e/usersguide/index.html">F2PY Users Guide</a> describes three
...
comments.</p>
<p>This example showcases the &#8220;quick and smart way.&#8221; There is another &#8220;smart
...
generate a signature file, after which you can edit it to your satisfaction.</p>
<p>Subroutine <tt class="docutils literal"><span class="pre">runbar3truss</span></tt> has the following interface:</p>
<div class="highlight-python"><div class="highlight"><pre> SUBROUTINE runbar3truss(PVEC,M0,A1,A2,A3,E,EL,RHO,
*                        S1,S2,S3,U,V,FF,OBJ)
</pre></div>
</div>
...
<div class="highlight-python"><div class="highlight"><pre>[unix_prompt]$ f2py -c -m bar3 bar3.f
</pre></div>
</div>
...
<div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">openmdao.examples.bar3simulation.bar3</span> <span class="kn">import</span> <span class="n">runbar3truss</span><span class="p">,</span> <span class="n">forces</span>
<span class="k">print</span> <span class="n">runbar3truss</span><span class="o">.</span><span class="n">__doc__</span>
</pre></div>
</div>
<div class="highlight-none"><div class="highlight"><pre>...
</pre></div>
</div>
<p>The auto generated docstring slightly differs depending on your version of numpy.</p>
<p>Auto-generated docstring if Numpy older than 1.8.0</p>
<div class="highlight-python"><div class="highlight"><pre>runbar3truss - Function signature:
...
<p>Auto-generated docstring starting with Numpy 1.8.0</p>
<div class="highlight-python"><div class="highlight"><pre>s1,s2,s3,u,v,ff,obj = runbar3truss(pvec,m0,a1,a2,a3,e,el,rho)
...
<div class="highlight-python"><div class="highlight"><pre>Wrapper Utility: SWIG
...
<div class="highlight-python"><div class="highlight"><pre>/* engineC_SWIG.i */
...
<div class="highlight-python"><div class="highlight"><pre>swig -python engineC_SWIG.i
...
<div class="highlight-python"><div class="highlight"><pre>Wrapper Utility: JCC
