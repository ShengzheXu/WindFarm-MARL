...
<p>A model is built from an assembly which contains components, drivers, and workflows.
...
<span class="k">class</span> <span class="nc">BasicModel</span><span class="p">(</span><span class="n">Assembly</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">configure</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="s">&#39;par&#39;</span><span class="p">,</span> <span class="n">Paraboloid</span><span class="p">())</span>

        <span class="c"># Add to driver&#39;s workflow</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">driver</span><span class="o">.</span><span class="n">workflow</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="s">&#39;par&#39;</span><span class="p">)</span>

<span class="k">if</span> <span class="n">__name__</span> <span class="o">==</span> <span class="s">&quot;__main__&quot;</span><span class="p">:</span>
    <span class="n">a</span> <span class="o">=</span> <span class="n">BasicModel</span><span class="p">()</span>
    <span class="n">x</span> <span class="o">=</span> <span class="mf">2.3</span>
    <span class="n">y</span> <span class="o">=</span> <span class="mf">7.2</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par</span><span class="o">.</span><span class="n">x</span> <span class="o">=</span> <span class="n">x</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par</span><span class="o">.</span><span class="n">y</span> <span class="o">=</span> <span class="n">y</span>
    <span class="n">a</span><span class="o">.</span><span class="n">run</span><span class="p">()</span>
    <span class="n">f</span> <span class="o">=</span> <span class="n">a</span><span class="o">.</span><span class="n">par</span><span class="o">.</span><span class="n">f_xy</span>
    <span class="k">print</span> <span class="s">&quot;Paraboloid with x = </span><span class="si">%f</span><span class="s"> and y = </span><span class="si">%f</span><span class="s"> has value </span><span class="si">%f</span><span class="s">&quot;</span> <span class="o">%</span> <span class="p">(</span> <span class="n">x</span><span class="p">,</span><span class="n">y</span><span class="p">,</span><span class="n">f</span> <span class="p">)</span>
</pre></div>
</div>
...
<span class="k">if</span> <span class="n">__name__</span> <span class="o">==</span> <span class="s">&quot;__main__&quot;</span><span class="p">:</span>
    <span class="n">a</span> <span class="o">=</span> <span class="n">ConnectingComponents</span><span class="p">()</span>

    <span class="n">a</span><span class="o">.</span><span class="n">par1</span><span class="o">.</span><span class="n">x</span> <span class="o">=</span> <span class="mf">2.3</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par1</span><span class="o">.</span><span class="n">y</span> <span class="o">=</span> <span class="mf">7.2</span>
    <span class="c">#a.par2.x = 3.4 # cannot do this because already connected to source par1.f_xy</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par2</span><span class="o">.</span><span class="n">y</span> <span class="o">=</span> <span class="mf">9.8</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par3</span><span class="o">.</span><span class="n">x</span> <span class="o">=</span> <span class="mf">1.5</span>
    <span class="c">#a.par3.y = 5.2 # cannot do this because already connected to source par2.f_xy</span>

    <span class="n">a</span><span class="o">.</span><span class="n">run</span><span class="p">()</span>

    <span class="k">print</span> <span class="s">&quot;Paraboloid 3 has output of </span><span class="si">%f</span><span class="s">&quot;</span> <span class="o">%</span> <span class="n">a</span><span class="o">.</span><span class="n">par3</span><span class="o">.</span><span class="n">f_xy</span>
</pre></div>
</div>
...
to the inputs for the next two.</p>
<div class="highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">openmdao.main.api</span> <span class="kn">import</span> <span class="n">Assembly</span>
<span class="kn">from</span> <span class="nn">openmdao.examples.simple.paraboloid</span> <span class="kn">import</span> <span class="n">Paraboloid</span>

<span class="k">class</span> <span class="nc">ConnectingComponentsUsingBroadcast</span><span class="p">(</span><span class="n">Assembly</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">configure</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">connect</span><span class="p">(</span><span class="s">&quot;par1.f_xy&quot;</span><span class="p">,[</span><span class="s">&quot;par2.x&quot;</span><span class="p">,</span><span class="s">&quot;par3.y&quot;</span><span class="p">])</span>
        <span class="c"># equivalent to</span>
        <span class="c">#self.connect(&quot;par1.f_xy&quot;,&quot;par2.x&quot;)</span>
        <span class="c">#self.connect(&quot;par1.f_xy&quot;,&quot;par3.y&quot;)</span>


<span class="k">if</span> <span class="n">__name__</span> <span class="o">==</span> <span class="s">&quot;__main__&quot;</span><span class="p">:</span>
    <span class="n">a</span> <span class="o">=</span> <span class="n">ConnectingComponentsUsingBroadcast</span><span class="p">()</span>
    ...
    <span class="n">a</span><span class="o">.</span><span class="n">par2</span><span class="o">.</span><span class="n">y</span> <span class="o">=</span> <span class="mf">9.8</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par3</span><span class="o">.</span><span class="n">x</span> <span class="o">=</span> <span class="mf">1.5</span>
    <span class="c">#a.par3.y = 5.2 # cannot do this because already connected to source par1.f_xy</span>
...
is just to issue two separate connections. Notice that both connection calls have <tt class="docutils literal"><span class="pre">par1.f_xy</span></tt>
...
<span class="k">class</span> <span class="nc">ConnectingComponentsUsingPassthroughs</span><span class="p">(</span><span class="n">Assembly</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot; Top level assembly &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">configure</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">create_passthrough</span><span class="p">(</span><span class="s">&#39;par1.x&#39;</span><span class="p">,</span> <span class="s">&#39;par1_x&#39;</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">create_passthrough</span><span class="p">(</span><span class="s">&#39;par1.y&#39;</span><span class="p">,</span> <span class="s">&#39;par1_y&#39;</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">create_passthrough</span><span class="p">(</span><span class="s">&#39;par2.y&#39;</span><span class="p">,</span> <span class="s">&#39;par2_y&#39;</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">create_passthrough</span><span class="p">(</span><span class="s">&#39;par2.f_xy&#39;</span><span class="p">,</span> <span class="s">&#39;par2_f_xy&#39;</span><span class="p">)</span>



<span class="k">if</span> <span class="n">__name__</span> <span class="o">==</span> <span class="s">&quot;__main__&quot;</span><span class="p">:</span>
    <span class="n">a</span> <span class="o">=</span> <span class="n">ConnectingComponentsUsingPassthroughs</span><span class="p">()</span>

    <span class="c">#set using assembly passthrough names</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par1_x</span> <span class="o">=</span> <span class="mf">8.2</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par1_y</span> <span class="o">=</span> <span class="mf">5.3</span>
    <span class="c">#a.par2.x = 1.2 # cannot do because already connected to par1.f_xy</span>
    <span class="c">#self.par2.y = 7.0  #cannot do this because it is passed thru to assembly level</span>
    <span class="n">a</span><span class="o">.</span><span class="n">par2_y</span> <span class="o">=</span> <span class="mf">9.9</span>

    <span class="n">a</span><span class="o">.</span><span class="n">run</span><span class="p">()</span>

    <span class="c">#getting var value with assembly passthrough name</span>
    <span class="k">print</span> <span class="s">&quot;passthrough value and direct value should be same&quot;</span><span class="p">,</span> <span class="n">a</span><span class="o">.</span><span class="n">par2_y</span><span class="p">,</span> <span class="n">a</span><span class="o">.</span><span class="n">par2</span><span class="o">.</span><span class="n">y</span>

    <span class="c">#use passthrough to get output of par2</span>
    <span class="k">print</span> <span class="s">&quot;output of par2 = &quot;</span><span class="p">,</span> <span class="n">a</span><span class="o">.</span><span class="n">par2_f_xy</span>
</pre></div>
</div>
...
connected. Most of the time passthroughs are sufficient.</p>
