...
<span class="sd">            Required resources. ``working_directory`` is used to set a</span>
<span class="sd">            created server&#39;s directory, other keys are ignored.</span>
<span class="sd">            If `allow_shell` has been set, then an absolute directory</span>
<span class="sd">            reference may be used (including &#39;~&#39; expansion). If not, then</span>
<span class="sd">            the reference must be relative and the working directory will be</span>
<span class="sd">            relative to the factory&#39;s directory. If the directory already</span>
<span class="sd">            exists, a new name will be used of the form ``&lt;directory&gt;_N``</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="k">if</span> <span class="n">server</span> <span class="ow">is</span> <span class="bp">None</span><span class="p">:</span>
            ...
            <span class="c"># Set (unique) working directory of server.</span>
            <span class="c"># Server cleanup removes this directory, so we avoid any</span>
            <span class="c"># existing directory to not delete existing files.</span>
            <span class="n">base</span> <span class="o">=</span> <span class="bp">None</span>
            <span class="k">if</span> <span class="n">res_desc</span> <span class="ow">is</span> <span class="ow">not</span> <span class="bp">None</span><span class="p">:</span>
                <span class="n">base</span> <span class="o">=</span> <span class="n">res_desc</span><span class="o">.</span><span class="n">get</span><span class="p">(</span><span class="s">&#39;working_directory&#39;</span><span class="p">)</span>
                <span class="k">if</span> <span class="n">base</span><span class="p">:</span>
                    <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_allow_shell</span><span class="p">:</span>  <span class="c"># Absolute allowed.</span>
                        <span class="n">base</span> <span class="o">=</span> <span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">expanduser</span><span class="p">(</span><span class="n">base</span><span class="p">)</span>
                    <span class="k">elif</span> <span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">isabs</span><span class="p">(</span><span class="n">base</span><span class="p">)</span> <span class="ow">or</span> <span class="n">base</span><span class="o">.</span><span class="n">startswith</span><span class="p">(</span><span class="s">&#39;..&#39;</span><span class="p">):</span>
                        <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&#39;working_directory </span><span class="si">%r</span><span class="s"> must be subdirectory&#39;</span>
                                         <span class="o">%</span> <span class="n">base</span><span class="p">)</span>
                    <span class="n">res_desc</span> <span class="o">=</span> <span class="n">res_desc</span><span class="o">.</span><span class="n">copy</span><span class="p">()</span>
                    <span class="k">del</span> <span class="n">res_desc</span><span class="p">[</span><span class="s">&#39;working_directory&#39;</span><span class="p">]</span>
            <span class="k">if</span> <span class="ow">not</span> <span class="n">base</span><span class="p">:</span>
                <span class="n">base</span> <span class="o">=</span> <span class="n">name</span>
            <span class="n">count</span> <span class="o">=</span> <span class="mi">1</span>
            <span class="n">root_dir</span> <span class="o">=</span> <span class="n">base</span>
            <span class="k">while</span> <span class="n">os</span><span class="o">.</span><span class="n">path</span><span class="o">.</span><span class="n">exists</span><span class="p">(</span><span class="n">root_dir</span><span class="p">):</span>
                <span class="n">count</span> <span class="o">+=</span> <span class="mi">1</span>
                <span class="n">root_dir</span> <span class="o">=</span> <span class="s">&#39;</span><span class="si">%s</span><span class="s">_</span><span class="si">%d</span><span class="s">&#39;</span> <span class="o">%</span> <span class="p">(</span><span class="n">base</span><span class="p">,</span> <span class="n">count</span><span class="p">)</span>
...
<div class="viewcode-block" id="ObjServer.set_log_level"><a class="viewcode-back" href="../../../srcdocs/packages/openmdao.main.html#openmdao.main.objserverfactory.ObjServer.set_log_level">[docs]</a>    <span class="k">def</span> <span class="nf">set_log_level</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">level</span><span class="p">):</span>
    ...
    <span class="nd">@rbac</span><span class="p">(</span><span class="s">&#39;owner&#39;</span><span class="p">)</span>
<div class="viewcode-block" id="ObjServer.config_ram"><a class="viewcode-back" href="../../../srcdocs/packages/openmdao.main.html#openmdao.main.objserverfactory.ObjServer.config_ram">[docs]</a>    <span class="k">def</span> <span class="nf">config_ram</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">filename</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">        Configure the :class:`ResourceAllocationManager` instance from `filename`.</span>
<span class="sd">        Used to define resources needed for model execution.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">debug</span><span class="p">(</span><span class="s">&#39;config_ram </span><span class="si">%r</span><span class="s">&#39;</span><span class="p">,</span> <span class="n">filename</span><span class="p">)</span>
        <span class="kn">from</span> <span class="nn">openmdao.main.resource</span> <span class="kn">import</span> <span class="n">ResourceAllocationManager</span>
        <span class="n">ResourceAllocationManager</span><span class="o">.</span><span class="n">configure</span><span class="p">(</span><span class="n">filename</span><span class="p">)</span>
</div>
    <span class="nd">@rbac</span><span class="p">(</span><span class="s">&#39;*&#39;</span><span class="p">)</span>
