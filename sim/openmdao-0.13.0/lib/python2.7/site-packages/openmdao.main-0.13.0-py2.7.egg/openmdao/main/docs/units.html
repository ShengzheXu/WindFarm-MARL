...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Appendix: Summary of Units &mdash; OpenMDAO Documentation</title>
    ...
    <link rel="prev" title="Sphinx and reStructuredText" href="documenting/sphinx.html" /> 
  </head>
  <body>
    <div class="related">
      <h3>Navigation</h3>
      <ul>
        ...
        <li class="right" >
          <a href="documenting/sphinx.html" title="Sphinx and reStructuredText"
  ...
  <div class="section" id="appendix-summary-of-units">
<span id="units"></span><h1>Appendix: Summary of Units<a class="headerlink" href="#appendix-summary-of-units" title="Permalink to this headline">¶</a></h1>
<p id="index-0">Generally SI units (<a class="reference external" href="http://www.bipm.org/utils/common/pdf/si_brochure_8_en.pdf">http://www.bipm.org/utils/common/pdf/si_brochure_8_en.pdf</a>)
...
sometimes multiple names for the same physical quantity (e.g., <tt class="docutils literal"><span class="pre">a</span></tt> and <tt class="docutils literal"><span class="pre">yr</span></tt>),
sometimes very similar names for different quantities (e.g., <tt class="docutils literal"><span class="pre">ton</span></tt>).
...
See the source documentation for the <a class="reference internal" href="srcdocs/packages/openmdao.units.html#openmdao-units-units-py"><em>units package</em></a>.</p>
<p>The following units are defined in the OpenMDAO units package:</p>
<div class="highlight-python"><div class="highlight"><pre># Default unit library definitions.  Much of this is based on
...
border="0" alt="OpenMDAO Home"/>
  ...
  <p class="topless"><a href="documenting/sphinx.html"
                        title="previous chapter">Sphinx and reStructuredText</a></p>
  <h4>Next topic</h4>
