...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>openmdao.lib.surrogatemodels.multifi_cokriging_surrogate &mdash; OpenMDAO Documentation</title>
  ...
  <h1>Source code for openmdao.lib.surrogatemodels.multifi_cokriging_surrogate</h1><div class="highlight"><pre>
<span class="sd">&quot;&quot;&quot;</span>
<span class="sd">This module integrates the Multi-Fidelity Co-Kriging method described in</span>
<span class="sd">[LeGratiet2013].</span>
...
<span class="kn">from</span> <span class="nn">numpy</span> <span class="kn">import</span> <span class="n">atleast_2d</span> <span class="k">as</span> <span class="n">array2d</span>
...
<span class="kn">from</span> <span class="nn">openmdao.main.interfaces</span> <span class="kn">import</span> <span class="n">implements</span><span class="p">,</span> <span class="n">IMultiFiSurrogate</span><span class="p">,</span> <span class="n">ISurrogate</span>
...
<span class="kn">from</span> <span class="nn">openmdao.main.api</span> <span class="kn">import</span> <span class="n">Container</span>
...
<span class="n">MACHINE_EPSILON</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">finfo</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">double</span><span class="p">)</span><span class="o">.</span><span class="n">eps</span> <span class="c"># machine precision</span>
<span class="n">NUGGET</span><span class="o">=</span> <span class="mf">10.</span><span class="o">*</span> <span class="n">MACHINE_EPSILON</span> <span class="c"># nugget for robustness</span>

<span class="n">INITIAL_RANGE_DEFAULT</span> <span class="o">=</span> <span class="mf">0.3</span> <span class="c"># initial range for optimizer</span>
<span class="n">TOLERANCE_DEFAULT</span>     <span class="o">=</span> <span class="mf">1e-6</span>    <span class="c"># stopping criterion for MLE optimization</span>
...
<span class="k">if</span> <span class="nb">hasattr</span><span class="p">(</span><span class="n">linalg</span><span class="p">,</span> <span class="s">&#39;solve_triangular&#39;</span><span class="p">):</span>
    <span class="c"># only in scipy since 0.9</span>
...
<span class="k">else</span><span class="p">:</span>
    <span class="c"># slower, but works</span>
    <span class="k">def</span> <span class="nf">solve_triangular</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">lower</span><span class="o">=</span><span class="bp">True</span><span class="p">):</span>
...
<div class="viewcode-block" id="constant_regression"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.constant_regression">[docs]</a><span class="k">def</span> <span class="nf">constant_regression</span><span class="p">(</span><span class="n">x</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
...
<div class="viewcode-block" id="linear_regression"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.linear_regression">[docs]</a><span class="k">def</span> <span class="nf">linear_regression</span><span class="p">(</span><span class="n">x</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
...
<div class="viewcode-block" id="squared_exponential_correlation"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.squared_exponential_correlation">[docs]</a><span class="k">def</span> <span class="nf">squared_exponential_correlation</span><span class="p">(</span><span class="n">theta</span><span class="p">,</span> <span class="n">d</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">elif</span> <span class="n">theta</span><span class="o">.</span><span class="n">size</span> <span class="o">!=</span> <span class="n">n_features</span><span class="p">:</span>
        <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;Length of theta must be 1 or </span><span class="si">%s</span><span class="s">&quot;</span> <span class="o">%</span> <span class="n">n_features</span><span class="p">)</span>
    <span class="k">else</span><span class="p">:</span>
        <span class="k">return</span> <span class="n">np</span><span class="o">.</span><span class="n">exp</span><span class="p">(</span><span class="o">-</span><span class="n">np</span><span class="o">.</span><span class="n">sum</span><span class="p">(</span><span class="n">theta</span><span class="o">.</span><span class="n">reshape</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="n">n_features</span><span class="p">)</span> <span class="o">*</span> <span class="n">d</span> <span class="o">**</span> <span class="mi">2</span><span class="p">,</span> <span class="n">axis</span><span class="o">=</span><span class="mi">1</span><span class="p">))</span>

</div>
<div class="viewcode-block" id="l1_cross_distances"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.l1_cross_distances">[docs]</a><span class="k">def</span> <span class="nf">l1_cross_distances</span><span class="p">(</span><span class="n">X</span><span class="p">,</span> <span class="n">Y</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">Computes the nonzero componentwise L1 cross-distances between the vectors</span>
<span class="sd">in X and Y.</span>
...
<span class="sd">&quot;&quot;&quot;</span>
    ...
    <span class="k">else</span><span class="p">:</span>
        ...
        <span class="k">if</span> <span class="n">n_features_X</span> <span class="o">!=</span> <span class="n">n_features_Y</span><span class="p">:</span>
            <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;X and Y must have the same dimensions.&quot;</span><span class="p">)</span>
        ...
        <span class="k">for</span> <span class="n">k</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">n_samples_X</span><span class="p">):</span>
            <span class="n">ll_0</span> <span class="o">=</span> <span class="n">ll_1</span>
            <span class="n">ll_1</span> <span class="o">=</span> <span class="n">ll_0</span> <span class="o">+</span> <span class="n">n_samples_Y</span><span class="c"># - k - 1</span>
...
<div class="viewcode-block" id="MultiFiCoKriging"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKriging">[docs]</a><span class="k">class</span> <span class="nc">MultiFiCoKriging</span><span class="p">(</span><span class="nb">object</span><span class="p">):</span>

    <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">This class integrates the Multi-Fidelity Co-Kriging method described in</span>
<span class="sd">[LeGratiet2013]_.</span>
...
<span class="sd">    Specified theta for each level OR the best set of autocorrelation parameters</span>
<span class="sd">    (the sought maximizer of the reduced likelihood function).</span>
<span class="sd">    </span>
<span class="sd">`rlf_value`: list</span>
<span class="sd">    The optimal negative concentrated reduced likelihood function value</span>
...
<span class="sd">&gt;&gt;&gt; from openmdao.lib.surrogatemodels.api import MultiFiCoKriging</span>
...
<span class="sd">&quot;&quot;&quot;</span>
    ...
    <span class="n">_regression_types</span> <span class="o">=</span> <span class="p">{</span>
        <span class="s">&#39;constant&#39;</span><span class="p">:</span> <span class="n">constant_regression</span><span class="p">,</span>
        <span class="s">&#39;linear&#39;</span><span class="p">:</span> <span class="n">linear_regression</span><span class="p">}</span>

    <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">regr</span><span class="o">=</span><span class="s">&#39;constant&#39;</span><span class="p">,</span> <span class="n">rho_regr</span><span class="o">=</span><span class="s">&#39;constant&#39;</span><span class="p">,</span> 
                 <span class="n">theta</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span> <span class="n">theta0</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span> <span class="n">thetaL</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span> <span class="n">thetaU</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">_build_R</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">lvl</span><span class="p">,</span> <span class="n">theta</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">        Builds the correlation matrix with given theta for the specified level.</span>
<span class="sd">        &quot;&quot;&quot;</span>
...
<div class="viewcode-block" id="MultiFiCoKriging.fit"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKriging.fit">[docs]</a>    <span class="k">def</span> <span class="nf">fit</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">X</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> 
            <span class="n">initial_range</span><span class="o">=</span><span class="n">INITIAL_RANGE_DEFAULT</span><span class="p">,</span> <span class="n">tol</span><span class="o">=</span><span class="n">TOLERANCE_DEFAULT</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">The Multi-Fidelity co-kriging model fitting method.</span>
...
<span class="sd">&quot;&quot;&quot;</span>
        ...
        <span class="c"># Transforms floats and arrays in lists to have a multifidelity structure</span>
        ...
        <span class="c"># Checks if all parameters are structured as required</span>
        ...
        <span class="c"># initialize lists</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">beta_rho</span> <span class="o">=</span> <span class="n">nlevel</span><span class="o">*</span><span class="p">[</span><span class="bp">None</span><span class="p">]</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">beta_regr</span> <span class="o">=</span> <span class="n">nlevel</span><span class="o">*</span><span class="p">[</span><span class="bp">None</span><span class="p">]</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">_R_adj</span> <span class="o">=</span> <span class="n">nlevel</span><span class="o">*</span><span class="p">[</span><span class="bp">None</span><span class="p">]</span>
        
        <span class="n">y_best</span> <span class="o">=</span> <span class="n">y</span><span class="p">[</span><span class="n">nlevel</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span>
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">nlevel</span><span class="o">-</span><span class="mi">1</span><span class="p">)[::</span><span class="o">-</span><span class="mi">1</span><span class="p">]:</span>
            <span class="n">y_best</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">concatenate</span><span class="p">((</span><span class="n">y</span><span class="p">[</span><span class="n">i</span><span class="p">][:</span><span class="o">-</span><span class="n">n_samples</span><span class="p">[</span><span class="n">i</span><span class="o">+</span><span class="mi">1</span><span class="p">]],</span><span class="n">y_best</span><span class="p">))</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">y_best</span> <span class="o">=</span> <span class="n">y_best</span>
            
        <span class="bp">self</span><span class="o">.</span><span class="n">y_mean</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">zeros</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">y_std</span>  <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">ones</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">X_mean</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">zeros</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">X_std</span>  <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">ones</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
        ...
        <span class="k">for</span> <span class="n">lvl</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">nlevel</span><span class="p">):</span>
            ...
            <span class="k">if</span> <span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">min</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">sum</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">D</span><span class="p">[</span><span class="n">lvl</span><span class="p">],</span> <span class="n">axis</span><span class="o">=</span><span class="mi">1</span><span class="p">))</span> <span class="o">==</span> <span class="mf">0.</span><span class="p">):</span>
                <span class="k">raise</span> <span class="ne">Exception</span><span class="p">(</span><span class="s">&quot;Multiple input features cannot have the same&quot;</span>
            ...
            <span class="c"># Concatenate the autoregressive part for levels &gt; 0</span>
            ...
            <span class="k">if</span> <span class="nb">int</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">p</span><span class="p">[</span><span class="n">lvl</span><span class="p">]</span> <span class="o">+</span> <span class="bp">self</span><span class="o">.</span><span class="n">q</span><span class="p">[</span><span class="n">lvl</span><span class="p">])</span> <span class="o">&gt;=</span> <span class="n">n_samples_F_i</span><span class="p">:</span>
                <span class="k">raise</span> <span class="ne">Exception</span><span class="p">((</span><span class="s">&quot;Ordinary least squares problem is undetermined &quot;</span>
                                 <span class="s">&quot;n_samples=</span><span class="si">%d</span><span class="s"> must be greater than the regression&quot;</span>
                                 <span class="s">&quot; model size p+q=</span><span class="si">%d</span><span class="s">.&quot;</span><span class="p">)</span>
        ...
        <span class="k">for</span> <span class="n">lvl</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">nlevel</span><span class="p">):</span>
            <span class="c"># Determine Gaussian Process model parameters</span>
            <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">theta</span><span class="p">[</span><span class="n">lvl</span><span class="p">]</span> <span class="ow">is</span> <span class="bp">None</span><span class="p">:</span>
                <span class="c"># Maximum Likelihood Estimation of the parameters                             </span>
                <span class="n">sol</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_max_rlf</span><span class="p">(</span><span class="n">lvl</span><span class="o">=</span><span class="n">lvl</span><span class="p">,</span> <span class="n">initial_range</span><span class="o">=</span><span class="n">initial_range</span><span class="p">,</span> <span class="n">tol</span><span class="o">=</span><span class="n">tol</span><span class="p">)</span>
                <span class="bp">self</span><span class="o">.</span><span class="n">theta</span><span class="p">[</span><span class="n">lvl</span><span class="p">]</span> <span class="o">=</span> <span class="n">sol</span><span class="p">[</span><span class="s">&#39;theta&#39;</span><span class="p">]</span>
                <span class="bp">self</span><span class="o">.</span><span class="n">rlf_value</span><span class="p">[</span><span class="n">lvl</span><span class="p">]</span> <span class="o">=</span> <span class="n">sol</span><span class="p">[</span><span class="s">&#39;rlf_value&#39;</span><span class="p">]</span>
...
<div class="viewcode-block" id="MultiFiCoKriging.rlf"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKriging.rlf">[docs]</a>    <span class="k">def</span> <span class="nf">rlf</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">lvl</span><span class="p">,</span> <span class="n">theta</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">This function determines the BLUP parameters and evaluates the negative reduced</span>
...
<span class="sd">self: Multi-Fidelity Co-Kriging object</span>
...
<span class="sd">rlf_value: double</span>
...
<span class="sd">&quot;&quot;&quot;</span>
        ...
        <span class="k">except</span> <span class="n">linalg</span><span class="o">.</span><span class="n">LinAlgError</span><span class="p">:</span>
            <span class="n">_logger</span><span class="o">.</span><span class="n">warning</span><span class="p">((</span><span class="s">&#39;Cholesky decomposition of R at level </span><span class="si">%i</span><span class="s"> failed&#39;</span> <span class="o">%</span> <span class="n">lvl</span><span class="p">)</span> <span class="o">+</span>
                             <span class="s">&#39; with theta=&#39;</span><span class="o">+</span><span class="nb">str</span><span class="p">(</span><span class="n">theta</span><span class="p">))</span>
            <span class="k">return</span> <span class="n">rlf_value</span>
               
        <span class="c"># Get generalized least squares solution</span>
        <span class="n">Ft</span> <span class="o">=</span> <span class="n">solve_triangular</span><span class="p">(</span><span class="n">C</span><span class="p">,</span> <span class="n">F</span><span class="p">,</span> <span class="n">lower</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span>
        <span class="n">Yt</span> <span class="o">=</span> <span class="n">solve_triangular</span><span class="p">(</span><span class="n">C</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">lower</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span>
        <span class="k">try</span><span class="p">:</span>
    ...
    <span class="k">def</span> <span class="nf">_max_rlf</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">lvl</span><span class="p">,</span> <span class="n">initial_range</span><span class="p">,</span> <span class="n">tol</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">This function estimates the autocorrelation parameter theta</span>
<span class="sd">as the maximizer of the reduced likelihood function of the given level (lvl).</span>
<span class="sd">(Minimization of the negative reduced likelihood function is used for convenience.)</span>

<span class="sd">`Parameters`</span>

<span class="sd">self: Most parameters are stored in the Gaussian Process model object.</span>
...
<span class="sd">optimal_rlf_value: double</span>
...
<span class="sd">&quot;&quot;&quot;</span>
        <span class="c"># Initialize input</span>
        ...
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">theta0</span><span class="o">.</span><span class="n">size</span><span class="p">):</span>
            <span class="n">constraints</span><span class="o">.</span><span class="n">append</span><span class="p">({</span><span class="s">&#39;type&#39;</span><span class="p">:</span> <span class="s">&#39;ineq&#39;</span><span class="p">,</span> <span class="s">&#39;fun&#39;</span><span class="p">:</span> <span class="k">lambda</span> <span class="n">log10t</span><span class="p">,</span><span class="n">i</span><span class="o">=</span><span class="n">i</span><span class="p">:</span>
        ...
        <span class="n">sol</span> <span class="o">=</span> <span class="n">minimize</span><span class="p">(</span><span class="n">rlf_transform</span><span class="p">,</span> <span class="n">x0</span><span class="p">,</span> <span class="n">method</span><span class="o">=</span><span class="s">&#39;COBYLA&#39;</span><span class="p">,</span>
                       <span class="n">constraints</span><span class="o">=</span><span class="n">constraints</span><span class="p">,</span>
                       <span class="n">options</span><span class="o">=</span><span class="p">{</span><span class="s">&#39;rhobeg&#39;</span><span class="p">:</span> <span class="n">initial_range</span><span class="p">,</span>
                                <span class="s">&#39;tol&#39;</span><span class="p">:</span> <span class="n">tol</span><span class="p">,</span> <span class="s">&#39;disp&#39;</span><span class="p">:</span> <span class="mi">0</span><span class="p">})</span>  
        
        <span class="n">log10_optimal_x</span> <span class="o">=</span> <span class="n">sol</span><span class="p">[</span><span class="s">&#39;x&#39;</span><span class="p">]</span>
        <span class="n">optimal_rlf_value</span> <span class="o">=</span> <span class="n">sol</span><span class="p">[</span><span class="s">&#39;fun&#39;</span><span class="p">]</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_nfev</span> <span class="o">+=</span> <span class="n">sol</span><span class="p">[</span><span class="s">&#39;nfev&#39;</span><span class="p">]</span>
        ...
        <span class="n">res</span><span class="p">[</span><span class="s">&#39;theta&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">optimal_theta</span>
        <span class="n">res</span><span class="p">[</span><span class="s">&#39;rlf_value&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">optimal_rlf_value</span>
        
        <span class="k">return</span> <span class="n">res</span>


<div class="viewcode-block" id="MultiFiCoKriging.predict"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKriging.predict">[docs]</a>    <span class="k">def</span> <span class="nf">predict</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">X</span><span class="p">,</span> <span class="n">eval_MSE</span><span class="o">=</span><span class="bp">True</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">This function performs the predictions of the kriging model on X.</span>
...
<span class="sd">MSE: array_like, optional (if eval_MSE is True)</span>
...
<span class="sd">&quot;&quot;&quot;</span>
        ...
        <span class="c"># Calculate kriging mean and variance at level 0</span>
        ...
        <span class="k">if</span> <span class="n">eval_MSE</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">sigma2_rho</span> <span class="o">=</span> <span class="n">nlevel</span><span class="o">*</span><span class="p">[</span><span class="bp">None</span><span class="p">]</span>
            ...
            <span class="n">r_t</span> <span class="o">=</span> <span class="n">solve_triangular</span><span class="p">(</span><span class="n">C</span><span class="p">,</span> <span class="n">r_</span><span class="o">.</span><span class="n">T</span><span class="p">,</span> <span class="n">lower</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span>
            ...
            <span class="n">MSE</span><span class="p">[:,</span><span class="mi">0</span><span class="p">]</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">sigma2</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span> <span class="o">*</span> <span class="p">(</span><span class="mi">1</span> \
                        <span class="o">-</span> <span class="p">(</span><span class="n">r_t</span><span class="o">**</span><span class="mi">2</span><span class="p">)</span><span class="o">.</span><span class="n">sum</span><span class="p">(</span><span class="n">axis</span><span class="o">=</span><span class="mi">0</span><span class="p">)</span> <span class="o">+</span> <span class="p">(</span><span class="n">u_</span><span class="o">**</span><span class="mi">2</span><span class="p">)</span><span class="o">.</span><span class="n">sum</span><span class="p">(</span><span class="n">axis</span><span class="o">=</span><span class="mi">0</span><span class="p">))</span>
    
        <span class="c"># Calculate recursively kriging mean and variance at level i</span>
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span><span class="n">nlevel</span><span class="p">):</span>
            ...
            <span class="n">r_</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">corr</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">theta</span><span class="p">[</span><span class="n">i</span><span class="p">],</span> <span class="n">dx</span><span class="p">)</span><span class="o">.</span><span class="n">reshape</span><span class="p">(</span><span class="n">n_eval</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">n_samples</span><span class="p">[</span><span class="n">i</span><span class="p">])</span>   
            ...
            <span class="k">if</span> <span class="n">eval_MSE</span><span class="p">:</span>
                ...
                <span class="n">sigma2_rho</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">dot</span><span class="p">(</span><span class="n">g</span><span class="p">,</span> \
                    <span class="bp">self</span><span class="o">.</span><span class="n">sigma2</span><span class="p">[</span><span class="n">i</span><span class="p">]</span><span class="o">*</span><span class="n">linalg</span><span class="o">.</span><span class="n">inv</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">dot</span><span class="p">(</span><span class="n">G</span><span class="o">.</span><span class="n">T</span><span class="p">,</span><span class="n">G</span><span class="p">))[:</span><span class="bp">self</span><span class="o">.</span><span class="n">q</span><span class="p">[</span><span class="n">i</span><span class="p">],:</span><span class="bp">self</span><span class="o">.</span><span class="n">q</span><span class="p">[</span><span class="n">i</span><span class="p">]]</span> \
        ...
        <span class="c"># scaled predictor                  </span>
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">nlevel</span><span class="p">):</span><span class="c"># Predictor</span>
        ...
        <span class="k">else</span><span class="p">:</span>
            <span class="k">return</span> <span class="n">mu</span><span class="p">[:,</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span><span class="o">.</span><span class="n">reshape</span><span class="p">((</span><span class="n">n_eval</span><span class="p">,</span><span class="mi">1</span><span class="p">))</span>
    ...
    <span class="k">def</span> <span class="nf">_check_list_structure</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">X</span><span class="p">,</span> <span class="n">y</span><span class="p">):</span>
        ...
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="n">nlevel</span><span class="p">):</span>
            ...
            <span class="k">if</span> <span class="n">i</span><span class="o">&gt;</span><span class="mi">1</span> <span class="ow">and</span> <span class="n">n_features</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">!=</span> <span class="n">n_features</span><span class="p">[</span><span class="n">i</span><span class="o">-</span><span class="mi">1</span><span class="p">]:</span>
                <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;All X must have the same number of columns.&quot;</span><span class="p">)</span>
            ...
            <span class="k">if</span> <span class="n">n_samples</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">!=</span> <span class="n">n_samples_y</span><span class="p">[</span><span class="n">i</span><span class="p">]:</span>
                <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;X and y must have the same number of rows.&quot;</span><span class="p">)</span>             
        ...
        <span class="k">elif</span> <span class="nb">len</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">theta</span><span class="p">)</span> <span class="o">!=</span> <span class="n">nlevel</span><span class="p">:</span>
            <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;theta must be a list of </span><span class="si">%d</span><span class="s"> element(s).&quot;</span> <span class="o">%</span> <span class="n">nlevel</span><span class="p">)</span> 
        ...
        <span class="k">elif</span> <span class="nb">len</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">theta0</span><span class="p">)</span> <span class="o">!=</span> <span class="n">nlevel</span><span class="p">:</span>
            <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;theta0 must be a list of </span><span class="si">%d</span><span class="s"> elements.&quot;</span> <span class="o">%</span> <span class="n">nlevel</span><span class="p">)</span>        
        ...
        <span class="k">elif</span> <span class="nb">len</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">thetaL</span><span class="p">)</span> <span class="o">!=</span> <span class="n">nlevel</span><span class="p">:</span>
            <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;thetaL must be a list of </span><span class="si">%d</span><span class="s"> elements.&quot;</span> <span class="o">%</span> <span class="n">nlevel</span><span class="p">)</span>
        ...
        <span class="k">elif</span> <span class="nb">len</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">thetaU</span><span class="p">)</span> <span class="o">!=</span> <span class="n">nlevel</span><span class="p">:</span>
            <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;thetaU must be a list of </span><span class="si">%d</span><span class="s"> elements.&quot;</span> <span class="o">%</span> <span class="n">nlevel</span><span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">_check_params</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        ...
        <span class="c"># Check rho regression model</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="nb">callable</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">rho_regr</span><span class="p">):</span>
            ...
            <span class="k">else</span><span class="p">:</span>
                <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;rho_regr should be one of </span><span class="si">%s</span><span class="s"> or callable, &quot;</span>
                                 <span class="s">&quot;</span><span class="si">%s</span><span class="s"> was given.&quot;</span>
        ...
        <span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">nlevel</span><span class="p">):</span>
            <span class="c"># Check correlation parameters</span>
            <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">theta</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="ow">is</span> <span class="ow">not</span> <span class="bp">None</span><span class="p">:</span>
                ...
                <span class="k">if</span> <span class="n">np</span><span class="o">.</span><span class="n">any</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">theta</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">&lt;=</span> <span class="mi">0</span><span class="p">):</span>
                    <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;theta0 must be strictly positive.&quot;</span><span class="p">)</span>
            
            <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">theta0</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="ow">is</span> <span class="ow">not</span> <span class="bp">None</span><span class="p">:</span>
            ...
            <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">thetaL</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="ow">is</span> <span class="ow">not</span> <span class="bp">None</span><span class="p">:</span>
                ...
                <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">thetaL</span><span class="p">[</span><span class="n">i</span><span class="p">]</span><span class="o">.</span><span class="n">size</span> <span class="o">!=</span> <span class="n">lth</span><span class="p">:</span>
                    <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;theta0 and thetaL must have the &quot;</span>
                                     <span class="s">&quot;same length.&quot;</span><span class="p">)</span>
            <span class="k">else</span><span class="p">:</span>
            ...
            <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">thetaU</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="ow">is</span> <span class="ow">not</span> <span class="bp">None</span><span class="p">:</span>
                ...
                <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">thetaU</span><span class="p">[</span><span class="n">i</span><span class="p">]</span><span class="o">.</span><span class="n">size</span> <span class="o">!=</span> <span class="n">lth</span><span class="p">:</span>
                    <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;theta0 and thetaU must have the &quot;</span>
                                     <span class="s">&quot;same length.&quot;</span><span class="p">)</span>
            <span class="k">else</span><span class="p">:</span>
            ...
            <span class="k">if</span> <span class="n">np</span><span class="o">.</span><span class="n">any</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">thetaL</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">&lt;=</span> <span class="mi">0</span><span class="p">)</span> <span class="ow">or</span> <span class="n">np</span><span class="o">.</span><span class="n">any</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">thetaU</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">&lt;</span> <span class="bp">self</span><span class="o">.</span><span class="n">thetaL</span><span class="p">[</span><span class="n">i</span><span class="p">]):</span>
                <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s">&quot;The bounds must satisfy O &lt; thetaL &lt;= &quot;</span>
                                 <span class="s">&quot;thetaU.&quot;</span><span class="p">)</span>

        <span class="k">return</span>

</div>
<div class="viewcode-block" id="MultiFiCoKrigingSurrogate"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKrigingSurrogate">[docs]</a><span class="k">class</span> <span class="nc">MultiFiCoKrigingSurrogate</span><span class="p">(</span><span class="n">Container</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">    OpenMDAO adapter of multi-fidelity recursive cokriging method described </span>
<span class="sd">    in [LeGratiet2013]. See MultiFiCoKriging class.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="n">implements</span><span class="p">(</span><span class="n">IMultiFiSurrogate</span><span class="p">,</span> <span class="n">ISurrogate</span><span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">regr</span><span class="o">=</span><span class="s">&#39;constant&#39;</span><span class="p">,</span> <span class="n">rho_regr</span><span class="o">=</span><span class="s">&#39;constant&#39;</span><span class="p">,</span> 
        ...
        <span class="nb">super</span><span class="p">(</span><span class="n">MultiFiCoKrigingSurrogate</span><span class="p">,</span> <span class="bp">self</span><span class="p">)</span><span class="o">.</span><span class="n">__init__</span><span class="p">()</span>
...
<div class="viewcode-block" id="MultiFiCoKrigingSurrogate.get_uncertain_value"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKrigingSurrogate.get_uncertain_value">[docs]</a>    <span class="k">def</span> <span class="nf">get_uncertain_value</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="n">value</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Returns a NormalDistribution centered around the value, with a</span>
<span class="sd">        standard deviation of 0.&quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="n">NormalDistribution</span><span class="p">(</span><span class="n">value</span><span class="p">,</span><span class="mf">0.</span><span class="p">)</span>
</div>
<div class="viewcode-block" id="MultiFiCoKrigingSurrogate.predict"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKrigingSurrogate.predict">[docs]</a>    <span class="k">def</span> <span class="nf">predict</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="n">new_x</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Calculates a predicted value of the response based on the current</span>
<span class="sd">        trained model for the supplied list of inputs (see ISurrogate).</span>
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="n">dist</span> <span class="o">=</span> <span class="n">NormalDistribution</span><span class="p">(</span><span class="n">Y_pred</span><span class="p">[</span><span class="mi">0</span><span class="p">][</span><span class="mi">0</span><span class="p">],</span> <span class="n">sqrt</span><span class="p">(</span><span class="nb">abs</span><span class="p">(</span><span class="n">MSE</span><span class="p">)))</span>
        <span class="k">return</span> <span class="n">dist</span>
</div>
<div class="viewcode-block" id="MultiFiCoKrigingSurrogate.train"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKrigingSurrogate.train">[docs]</a>    <span class="k">def</span> <span class="nf">train</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="n">X</span><span class="p">,</span><span class="n">Y</span><span class="p">):</span>
...
<span class="sd">        &quot;&quot;&quot;</span> 
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">model</span><span class="o">.</span><span class="n">fit</span><span class="p">(</span><span class="n">X</span><span class="p">,</span> <span class="n">Y</span><span class="p">,</span><span class="n">tol</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">tolerance</span><span class="p">,</span> <span class="n">initial_range</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">initial_range</span><span class="p">)</span>
        </div>
<div class="viewcode-block" id="MultiFiCoKrigingSurrogate.train_multifi"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.MultiFiCoKrigingSurrogate.train_multifi">[docs]</a>    <span class="k">def</span> <span class="nf">train_multifi</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="n">X</span><span class="p">,</span><span class="n">Y</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Train the surrogate model with the given set of inputs and outputs.</span>
<span class="sd">        &quot;&quot;&quot;</span> 
        <span class="n">X</span><span class="p">,</span> <span class="n">Y</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_fit_adapter</span><span class="p">(</span><span class="n">X</span><span class="p">,</span> <span class="n">Y</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">model</span><span class="o">.</span><span class="n">fit</span><span class="p">(</span><span class="n">X</span><span class="p">,</span> <span class="n">Y</span><span class="p">,</span><span class="n">tol</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">tolerance</span><span class="p">,</span> <span class="n">initial_range</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">initial_range</span><span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">_fit_adapter</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">X</span><span class="p">,</span> <span class="n">Y</span><span class="p">):</span>
        <span class="c"># Manage special case with one fidelity</span>
        <span class="c"># where can be called as [[xval1],[xval2]] instead of [[[xval1],[xval2]]]</span>
        <span class="c"># we detect if shape(X[0]) is like (m,) instead of (m, n)</span>
...
<div class="viewcode-block" id="FloatMultiFiCoKrigingSurrogate"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.FloatMultiFiCoKrigingSurrogate">[docs]</a><span class="k">class</span> <span class="nc">FloatMultiFiCoKrigingSurrogate</span><span class="p">(</span><span class="n">MultiFiCoKrigingSurrogate</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;Predictions are returned as floats, which are the mean of the </span>
<span class="sd">    NormalDistribution predicted by the base class model.&quot;&quot;&quot;</span>

    <span class="k">def</span> <span class="nf">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">regr</span><span class="o">=</span><span class="s">&#39;constant&#39;</span><span class="p">,</span> <span class="n">rho_regr</span><span class="o">=</span><span class="s">&#39;constant&#39;</span><span class="p">,</span> 
                 <span class="n">theta</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span> <span class="n">theta0</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span> <span class="n">thetaL</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span> <span class="n">thetaU</span><span class="o">=</span><span class="bp">None</span><span class="p">,</span>
                 <span class="n">tolerance</span><span class="o">=</span><span class="n">TOLERANCE_DEFAULT</span><span class="p">,</span> <span class="n">initial_range</span><span class="o">=</span><span class="n">INITIAL_RANGE_DEFAULT</span><span class="p">):</span>
        <span class="nb">super</span><span class="p">(</span><span class="n">FloatMultiFiCoKrigingSurrogate</span><span class="p">,</span> <span class="bp">self</span><span class="p">)</span><span class="o">.</span><span class="n">__init__</span><span class="p">(</span><span class="n">regr</span><span class="p">,</span> <span class="n">rho_regr</span><span class="p">,</span> <span class="n">theta</span><span class="p">,</span>
                                                             <span class="n">theta0</span><span class="p">,</span> <span class="n">thetaL</span><span class="p">,</span> <span class="n">thetaU</span><span class="p">,</span>
                                                             <span class="n">tolerance</span><span class="p">,</span> <span class="n">initial_range</span><span class="p">)</span>
        
<div class="viewcode-block" id="FloatMultiFiCoKrigingSurrogate.predict"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.FloatMultiFiCoKrigingSurrogate.predict">[docs]</a>    <span class="k">def</span> <span class="nf">predict</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">new_x</span><span class="p">):</span>
        <span class="n">dist</span> <span class="o">=</span> <span class="nb">super</span><span class="p">(</span><span class="n">FloatMultiFiCoKrigingSurrogate</span><span class="p">,</span><span class="bp">self</span><span class="p">)</span><span class="o">.</span><span class="n">predict</span><span class="p">(</span><span class="n">new_x</span><span class="p">)</span>
        <span class="k">return</span> <span class="n">dist</span><span class="o">.</span><span class="n">mu</span>
</div>
<div class="viewcode-block" id="FloatMultiFiCoKrigingSurrogate.get_uncertain_value"><a class="viewcode-back" href="../../../../srcdocs/packages/openmdao.lib.html#openmdao.lib.surrogatemodels.multifi_cokriging_surrogate.FloatMultiFiCoKrigingSurrogate.get_uncertain_value">[docs]</a>    <span class="k">def</span> <span class="nf">get_uncertain_value</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">value</span><span class="p">):</span>
