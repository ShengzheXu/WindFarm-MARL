...
def minimum_st_edge_cut(G, s, t, flow_func=None, auxiliary=None,
    ...
    data structures that NetworkX uses in the support: the
    auxiliary digraph for edge connectivity, and the residual
    network for the underlying maximum flow support.
...
def minimum_st_node_cut(G, s, t, flow_func=None, auxiliary=None, residual=None):
    ...
    residual network for the underlying maximum flow support.
...
def minimum_node_cut(G, s=None, t=None, flow_func=None):
    ...
    flow support. In dense networks the algorithm
...
def minimum_edge_cut(G, s=None, t=None, flow_func=None):
    ...
    maximum flow support. In dense networks the algorithm
    :meth:`shortest_augmenting_path` will usually perform better 
    than the default :meth:`edmonds_karp`, which is faster for 
