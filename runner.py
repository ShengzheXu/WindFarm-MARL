...
from support.PreTrainMachine import PreTrainMachine
...
beforeExp = PreTrainMachine(26)

if preTrainModel is True:
    beforeExp.transferExp(agentExperience)
...
def runner():
    ...
    for eps in range(0, episode):
        ...
        if preTrainModel is False:
            epsReward, epscount = runSimmEpisode()
            for i in range(turbineNum):
        ...
        if shareModel is True:
            ...
            for _ in range(min(totalExpNum/batchSize, 40)):
